...
export function generateKey (colourMap: ColourMap, valueFormatter: Formatter): [string, string][] {
  const rangeHasNegativeNums = Object.entries(colourMap.colourMap).some(entry => {
...
export function setOpacity (colourString: string, opacity: number): string | null {
