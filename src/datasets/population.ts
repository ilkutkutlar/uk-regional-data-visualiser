...
const metadata = {
  id: 'population_local',
  name: 'Population',
  description: 'Estimated resident population of each region. The estimates are produced on the 30th of June for every year.',
  source: 'Office for National Statistics (ONS)',
  sourceLink: 'https://www.ons.gov.uk/datasets/mid-year-pop-est/editions/mid-2020-april-2021-geography/versions/1'
}
